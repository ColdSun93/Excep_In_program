...
Папка "\hw_2\" содержит проекты по второй домашней работе.[Cсылка](https://github.com/ColdSun93/Excep_In_program/tree/main/hw_2 "проект").
...
Папка "\hw_2\" содержит проекты по второй домашней работе.[Cсылка](https://github.com/ColdSun93/Excep_In_program/tree/main/hw_3 "проект").
